...
export default function SidBar() {
  const them = useAppSelector((state) => state.theme.colors);
    const Arr=[
      ...
      {name:'Students',icon:<PermIdentityIcon/>,path:"/StudentDetails"},
      {name:'Teachers',icon:<PermIdentityIcon/>,path:"TeacherDetails"},
      {name:'Event',icon:   <MailIcon/>,path:"Food"},
      {name:'Finance',icon:   <MailIcon/>,path:"/Finance"},    
      {name:'User',icon:   <MailIcon/>,path:"/User"},
      {name:'Chat',icon:   <QuestionAnswerIcon/>,path:"/Chat"},
      {name:'Lastest Activity',icon:   <CelebrationIcon/>,path:"FoodDetails"},
