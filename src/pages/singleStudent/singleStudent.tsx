...
{/* ----------------------------------- */}
<div style={{ background:them.Navsheet }} className=' w-3/4   mt-4 '>
...
<button className=' border-0' style={{ background:them.Navsheet,color:them.fontColor  }}><MoreHorizIcon/> </button>
</div>
...
<small  >Interest</small>
    ...
    <div className=' cercl p-2 text-center  '>
