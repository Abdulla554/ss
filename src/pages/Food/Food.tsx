...
<h6 style={{ background:them.gray,color:them.blackColor}} className=' rounded-full w-10 h-10 pt-2  border-0  text-center  '><SettingsIcon/></h6>
...
<button className=' border-0' style={{ background:them.Darkblue,color:them.fontColor  }}><MoreHorizIcon/> </button>
