...
function Schedule() {
  ...
  return (
    <div className='  w-72'>
        {/* 111111111 */}
     <div className=' h-20 rounded-2xl  pt-2 mt-7' style={{ background:them.Navsheet }}>
        <div className='   mr-6'>
...
{[them.button,them.OrngColor,them.ylawoColor,them.fontColor].map((e)=>{
  return(
<div className=' flex'>
<div className='h-[135px] w-[15px] mt-3 ml-2 rounded-br-full  rounded-tr-full' style={{ background:e }} />
...
<div className='  '>
  ...
  <small className='mr-2 '>March 20, 2021</small>
  </div>


<div className='mt-1 '>
<AlarmIcon style={{ color:them.ylawoColor }} fontSize='small'/>
<small className='mr-2 '>09.00 - 10.00 AM</small>
</div>
...
<button  className=' rounded-full mt-5 pt-2   w-[275px] border-0 mr-1 h-11' style={{color:them.fontColor, background:them.button }}>
  <p>عرض المزيد</p>
</button>
